...
export const DEMO_CONFIGS = {
  ...
  'film': {
    name: 'Film', isPremium: true,
    layout: 'film',
    sections: FULL_SECTIONS,
    theme: { background: '#0D0D0D', accent: '#8B6914', text: '#F0EAE0', fontFamily: 'Cormorant SC', titleSize: '3.5rem' },
    content: { ...BASE, image_url: 'https://images.unsplash.com/photo-1437603565260-19658b689228?w=1200', intro_text: '"Une histoire d\'amour pour l\'éternité."' },
    media: { image_url: 'https://images.unsplash.com/photo-1437603565260-19658b689228?w=1200', music_url: '', splash_url: '' },
    show_countdown: true, show_splash: false,
  },
  'brutaliste': {
    name: 'Brutaliste', isPremium: true,
    layout: 'brutaliste',
    sections: FULL_SECTIONS,
    theme: { background: '#9E9E9E', accent: '#FF3E00', text: '#000000', fontFamily: 'Inter', titleSize: '3.5rem' },
    content: { ...BASE },
    media: { image_url: '', music_url: '', splash_url: '' },
    show_countdown: true, show_splash: false,
  },
